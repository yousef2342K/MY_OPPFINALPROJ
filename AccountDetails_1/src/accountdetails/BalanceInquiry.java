 ...
 * @author JoeKhalid
 */
import accountdetails.interfaces.BalanceInquiryinterface;
import java.io.File;
import java.io.IOException;
import java.util.Scanner;

public class BalanceInquiry implements BalanceInquiryinterface {
    @Override
    public void balanceInquiryFun(int accNo) throws IOException {
